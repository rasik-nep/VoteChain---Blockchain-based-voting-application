...
contract("Election",function(accounts){
    ...
    //to check if the contract was initialized with the correct number of candidates
    ...
    // it initializes the candidate with correct values
    it("it initializes the candidates with the correct values", function() {
        //promise chain as it is async
        return Election.deployed().then(function(instance) {
    ...
    //check two things
    //1.function increments the vote count of the candidate
    //2.voter was added to the mapping
    ...
    //when the voter for candidate not in the list
